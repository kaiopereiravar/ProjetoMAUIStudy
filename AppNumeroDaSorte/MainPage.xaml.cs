...
public partial class MainPage : ContentPage
{
	...
	private void OnGenerateLuckNumbers(object sender, EventArgs e)
	{
		...
		LuckNumber01.Text = set.ElementAt(0).ToString("D2");//D2 é a quantidade de caracteres que ele tem que retornar
	...
	{
        //SortedSet é um tipo de lista que nao deixam os elementos se repetirem
